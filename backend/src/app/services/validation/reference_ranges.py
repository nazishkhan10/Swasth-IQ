...
STANDARD_REFERENCE_RANGES: Dict[str, Dict[str, Any]] = {
    ...
    "MCV": {
        "unit": "fL",
        "default": {"low": 81.0, "high": 101.0, "text": "81.0 - 101.0 fL"}
    },
    "MCH": {
        "unit": "pg",
        "default": {"low": 27.0, "high": 33.0, "text": "27.0 - 33.0 pg"}
    },
    "MCHC": {
        "unit": "g/dL",
        "default": {"low": 31.5, "high": 34.5, "text": "31.5 - 34.5 g/dL"}
    },
    "HCT": {
        "unit": "%",
        "default": {"low": 40.0, "high": 50.0, "text": "40.0 - 50.0 %"}
    },
    "PCV": {
        "unit": "%",
        "default": {"low": 40.0, "high": 50.0, "text": "40.0 - 50.0 %"}
    ...
    "NEUT": {
        "unit": "%",
        "default": {"low": 40.0, "high": 80.0, "text": "40.0 - 80.0 %"}
    },
    "LYMPH": {
        "unit": "%",
        "default": {"low": 20.0, "high": 40.0, "text": "20.0 - 40.0 %"}
    },
    "EO": {
        "unit": "%",
        "default": {"low": 1.0, "high": 6.0, "text": "1.0 - 6.0 %"}
    },
    "MONO": {
        "unit": "%",
        "default": {"low": 2.0, "high": 10.0, "text": "2.0 - 10.0 %"}
    },
    "BASO": {
        "unit": "%",
        "default": {"low": 0.0, "high": 1.0, "text": "0.0 - 1.0 %"}
    },
